...
abstract class AbstractAnalysisBotanyTaxonomyVoter extends Voter
{
    ...
    abstract protected function getAnalysis(mixed $subject): object;

    protected function supports(string $attribute, mixed $subject): bool
    {
        return $this->isAttributeSupported($attribute)
            && $subject instanceof ($this->getSupportedClass());
    }
    ...
    protected function voteOnAttribute(string $attribute, $subject, TokenInterface $token, ?Vote $vote = null): bool
    {
        ...
        return $this->security->isGranted($attribute, $this->getAnalysis($subject));
    }
}
