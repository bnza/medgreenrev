...
final class Version20250621090503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE analysis_sediment_core_depth_botany_taxonomies (id BIGINT NOT NULL, cf BOOLEAN DEFAULT false NOT NULL, sp BOOLEAN DEFAULT false NOT NULL, type BOOLEAN DEFAULT false NOT NULL, analysis_id BIGINT NOT NULL, taxonomy_id SMALLINT NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE history_animals (id BIGINT NOT NULL, animal VARCHAR(255) NOT NULL, chronology_lower SMALLINT NOT NULL, chronology_upper SMALLINT NOT NULL, reference VARCHAR(255) NOT NULL, notes VARCHAR(255) DEFAULT NULL, age_id SMALLINT NOT NULL, taxonomy_id SMALLINT DEFAULT NULL, location_id BIGINT NOT NULL, created_by_id UUID DEFAULT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_B20B4537CC80CD12 ON history_animals (age_id)');
        $this->addSql('CREATE INDEX IDX_B20B45379557E6F6 ON history_animals (taxonomy_id)');
        ...
        $this->addSql('CREATE TABLE history_plants (id BIGINT NOT NULL, plant VARCHAR(255) NOT NULL, cf BOOLEAN DEFAULT false NOT NULL, sp BOOLEAN DEFAULT false NOT NULL, chronology_lower SMALLINT NOT NULL, chronology_upper SMALLINT NOT NULL, reference VARCHAR(255) NOT NULL, notes VARCHAR(255) DEFAULT NULL, age_id SMALLINT NOT NULL, taxonomy_id SMALLINT DEFAULT NULL, location_id BIGINT NOT NULL, created_by_id UUID DEFAULT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_762190E5CC80CD12 ON history_plants (age_id)');
        $this->addSql('CREATE INDEX IDX_762190E59557E6F6 ON history_plants (taxonomy_id)');
        ...
        $this->addSql('ALTER TABLE history_animals ADD CONSTRAINT FK_B20B45379557E6F6 FOREIGN KEY (taxonomy_id) REFERENCES vocabulary.zoo_taxonomy (id) ON DELETE RESTRICT NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE history_plants ADD CONSTRAINT FK_762190E59557E6F6 FOREIGN KEY (taxonomy_id) REFERENCES vocabulary.botany_taxonomy (id) ON DELETE RESTRICT NOT DEFERRABLE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE history_animals DROP CONSTRAINT FK_B20B45379557E6F6');
        ...
        $this->addSql('ALTER TABLE history_plants DROP CONSTRAINT FK_762190E59557E6F6');
