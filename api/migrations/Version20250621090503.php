...
final class Version20250621090503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE analysis_sediment_core_depth_botany_taxonomies_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE SEQUENCE vocabulary.zoo_bone_end_preserved_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE abs_dating_analysis_botany_charcoals (dating_lower SMALLINT NOT NULL, dating_upper SMALLINT NOT NULL, uncalibrated_dating SMALLINT NOT NULL, error SMALLINT NOT NULL, calibration_curve VARCHAR(255) NOT NULL, probability NUMERIC(4, 1) DEFAULT NULL, notes TEXT DEFAULT NULL, id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE TABLE abs_dating_analysis_botany_seeds (dating_lower SMALLINT NOT NULL, dating_upper SMALLINT NOT NULL, uncalibrated_dating SMALLINT NOT NULL, error SMALLINT NOT NULL, calibration_curve VARCHAR(255) NOT NULL, probability NUMERIC(4, 1) DEFAULT NULL, notes TEXT DEFAULT NULL, id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE TABLE abs_dating_analysis_individuals (dating_lower SMALLINT NOT NULL, dating_upper SMALLINT NOT NULL, uncalibrated_dating SMALLINT NOT NULL, error SMALLINT NOT NULL, calibration_curve VARCHAR(255) NOT NULL, probability NUMERIC(4, 1) DEFAULT NULL, notes TEXT DEFAULT NULL, id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE TABLE abs_dating_analysis_potteries (dating_lower SMALLINT NOT NULL, dating_upper SMALLINT NOT NULL, uncalibrated_dating SMALLINT NOT NULL, error SMALLINT NOT NULL, calibration_curve VARCHAR(255) NOT NULL, probability NUMERIC(4, 1) DEFAULT NULL, notes TEXT DEFAULT NULL, id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE TABLE abs_dating_analysis_samples (dating_lower SMALLINT NOT NULL, dating_upper SMALLINT NOT NULL, uncalibrated_dating SMALLINT NOT NULL, error SMALLINT NOT NULL, calibration_curve VARCHAR(255) NOT NULL, probability NUMERIC(4, 1) DEFAULT NULL, notes TEXT DEFAULT NULL, id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE TABLE abs_dating_analysis_sediment_core_depths (dating_lower SMALLINT NOT NULL, dating_upper SMALLINT NOT NULL, uncalibrated_dating SMALLINT NOT NULL, error SMALLINT NOT NULL, calibration_curve VARCHAR(255) NOT NULL, probability NUMERIC(4, 1) DEFAULT NULL, notes TEXT DEFAULT NULL, id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE TABLE abs_dating_analysis_zoo_bones (dating_lower SMALLINT NOT NULL, dating_upper SMALLINT NOT NULL, uncalibrated_dating SMALLINT NOT NULL, error SMALLINT NOT NULL, calibration_curve VARCHAR(255) NOT NULL, probability NUMERIC(4, 1) DEFAULT NULL, notes TEXT DEFAULT NULL, id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE TABLE abs_dating_analysis_zoo_teeth (dating_lower SMALLINT NOT NULL, dating_upper SMALLINT NOT NULL, uncalibrated_dating SMALLINT NOT NULL, error SMALLINT NOT NULL, calibration_curve VARCHAR(255) NOT NULL, probability NUMERIC(4, 1) DEFAULT NULL, notes TEXT DEFAULT NULL, id BIGINT NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE analysis_context_botany_taxonomies (id BIGINT NOT NULL, cf BOOLEAN DEFAULT false NOT NULL, sp BOOLEAN DEFAULT false NOT NULL, type BOOLEAN DEFAULT false NOT NULL, analysis_id BIGINT NOT NULL, taxonomy_id INT NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE analysis_sample_botany_taxonomies (id BIGINT NOT NULL, cf BOOLEAN DEFAULT false NOT NULL, sp BOOLEAN DEFAULT false NOT NULL, type BOOLEAN DEFAULT false NOT NULL, analysis_id BIGINT NOT NULL, taxonomy_id INT NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE analysis_sediment_core_depth_botany_taxonomies (id BIGINT NOT NULL, cf BOOLEAN DEFAULT false NOT NULL, sp BOOLEAN DEFAULT false NOT NULL, type BOOLEAN DEFAULT false NOT NULL, analysis_id BIGINT NOT NULL, taxonomy_id INT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_C9C460717941003F ON analysis_sediment_core_depth_botany_taxonomies (analysis_id)');
        $this->addSql('CREATE INDEX IDX_C9C460719557E6F6 ON analysis_sediment_core_depth_botany_taxonomies (taxonomy_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_C9C460717941003F9557E6F6 ON analysis_sediment_core_depth_botany_taxonomies (analysis_id, taxonomy_id)');
        $this->addSql('CREATE TABLE analysis_sediment_core_depths (summary TEXT DEFAULT NULL, id BIGINT NOT NULL, analysis_id BIGINT NOT NULL, subject_id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_5AAF384D7941003F ON analysis_sediment_core_depths (analysis_id)');
        $this->addSql('CREATE INDEX IDX_5AAF384D23EDC87 ON analysis_sediment_core_depths (subject_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_5AAF384D23EDC877941003F ON analysis_sediment_core_depths (subject_id, analysis_id)');
        $this->addSql('CREATE TABLE analysis_sediment_core_depths_botany (summary TEXT DEFAULT NULL, id BIGINT NOT NULL, analysis_id BIGINT NOT NULL, subject_id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_F27267787941003F ON analysis_sediment_core_depths_botany (analysis_id)');
        $this->addSql('CREATE INDEX IDX_F272677823EDC87 ON analysis_sediment_core_depths_botany (subject_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_F272677823EDC877941003F ON analysis_sediment_core_depths_botany (subject_id, analysis_id)');
        ...
        $this->addSql('CREATE TABLE botany_charcoals (id BIGINT NOT NULL, cf BOOLEAN DEFAULT false NOT NULL, sp BOOLEAN DEFAULT false NOT NULL, type BOOLEAN DEFAULT false NOT NULL, notes VARCHAR(255) DEFAULT NULL, stratigraphic_unit_id BIGINT NOT NULL, voc_taxonomy_id INT DEFAULT NULL, voc_element_part_id SMALLINT DEFAULT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE botany_seeds (id BIGINT NOT NULL, cf BOOLEAN DEFAULT false NOT NULL, sp BOOLEAN DEFAULT false NOT NULL, type BOOLEAN DEFAULT false NOT NULL, notes VARCHAR(255) DEFAULT NULL, stratigraphic_unit_id BIGINT NOT NULL, voc_taxonomy_id INT DEFAULT NULL, voc_element_id SMALLINT DEFAULT NULL, voc_element_part_id SMALLINT DEFAULT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE vocabulary.botany_taxonomy (id INT NOT NULL, value VARCHAR(255) NOT NULL, level VARCHAR(255) NOT NULL, spanish_name VARCHAR(255) DEFAULT NULL, english_name VARCHAR(255) DEFAULT NULL, parent_id INT DEFAULT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_37216ECA734D08E1 ON vocabulary.botany_taxonomy (english_name)');
        ...
        $this->addSql('CREATE TABLE vocabulary.decoration (id SMALLINT NOT NULL, value VARCHAR(255) NOT NULL, variant VARCHAR(255) DEFAULT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_4B9C50A41D775834 ON vocabulary.decoration (value)');
        $this->addSql('CREATE TABLE history_animals (id BIGINT NOT NULL, animal VARCHAR(255) NOT NULL, chronology_lower SMALLINT NOT NULL, chronology_upper SMALLINT NOT NULL, reference VARCHAR(255) NOT NULL, notes VARCHAR(255) DEFAULT NULL, age_id SMALLINT NOT NULL, location_id BIGINT NOT NULL, created_by_id UUID DEFAULT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE history_plants (id BIGINT NOT NULL, plant VARCHAR(255) NOT NULL, chronology_lower SMALLINT NOT NULL, chronology_upper SMALLINT NOT NULL, reference VARCHAR(255) NOT NULL, notes VARCHAR(255) DEFAULT NULL, age_id SMALLINT NOT NULL, location_id BIGINT NOT NULL, created_by_id UUID DEFAULT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE vocabulary.individual_sexes (id SMALLINT NOT NULL, value VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE potteries (id BIGINT NOT NULL, inventory VARCHAR(255) NOT NULL, inner_color VARCHAR(255) DEFAULT NULL, outer_color VARCHAR(255) DEFAULT NULL, decoration_motif VARCHAR(255) DEFAULT NULL, chronology_lower INT DEFAULT NULL, chronology_upper INT DEFAULT NULL, notes TEXT DEFAULT NULL, stratigraphic_unit_id BIGINT NOT NULL, surface_treatment_id SMALLINT DEFAULT NULL, cultural_context_id SMALLINT DEFAULT NULL, part_id SMALLINT DEFAULT NULL, functional_form_id SMALLINT NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE vocabulary.pottery_functional_forms (id SMALLINT NOT NULL, value VARCHAR(255) NOT NULL, variant VARCHAR(255) DEFAULT NULL, functional_group_id SMALLINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_703164D21D775834 ON vocabulary.pottery_functional_forms (value)');
        $this->addSql('CREATE INDEX IDX_703164D29D56156 ON vocabulary.pottery_functional_forms (functional_group_id)');
        ...
        $this->addSql('CREATE TABLE vocabulary.pottery_shapes (id SMALLINT NOT NULL, value VARCHAR(255) NOT NULL, variant VARCHAR(255) DEFAULT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE sediment_core_depths (id BIGINT NOT NULL, depth_min NUMERIC(5, 1) NOT NULL, depth_max NUMERIC(5, 1) NOT NULL, notes TEXT DEFAULT NULL, geochemistry BOOLEAN NOT NULL, micro_charcoal BOOLEAN NOT NULL, organic_chemistry BOOLEAN NOT NULL, osl_dating BOOLEAN NOT NULL, phytoliths BOOLEAN NOT NULL, plant_macro_remains BOOLEAN NOT NULL, pollen BOOLEAN NOT NULL, sedimentary_dna BOOLEAN NOT NULL, sediment_core_id BIGINT NOT NULL, su_id BIGINT NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE vocabulary.surface_treatment (id SMALLINT NOT NULL, value VARCHAR(255) NOT NULL, variant VARCHAR(255) DEFAULT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE vocabulary.zoo_bone_end_preserved (id SMALLINT NOT NULL, code VARCHAR(255) NOT NULL, value VARCHAR(255) NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_7FE32D7677153098 ON vocabulary.zoo_bone_end_preserved (code)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_7FE32D761D775834 ON vocabulary.zoo_bone_end_preserved (value)');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_AD4BDA3C734D08E1 ON vocabulary.zoo_taxonomy (english_name)');
        ...
        $this->addSql('ALTER TABLE abs_dating_analysis_samples ADD CONSTRAINT FK_ADDD1B67BF396750 FOREIGN KEY (id) REFERENCES analysis_samples (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE abs_dating_analysis_sediment_core_depths ADD CONSTRAINT FK_515C9693BF396750 FOREIGN KEY (id) REFERENCES analysis_sediment_core_depths (id) ON DELETE CASCADE NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE analysis_botany_charcoals ADD CONSTRAINT FK_538700097941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_botany_charcoals ADD CONSTRAINT FK_5387000923EDC87 FOREIGN KEY (subject_id) REFERENCES botany_charcoals (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_botany_seeds ADD CONSTRAINT FK_75FEF2947941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_botany_seeds ADD CONSTRAINT FK_75FEF29423EDC87 FOREIGN KEY (subject_id) REFERENCES botany_seeds (id) ON DELETE RESTRICT NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE analysis_contexts_botany ADD CONSTRAINT FK_762809397941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_contexts_botany ADD CONSTRAINT FK_7628093923EDC87 FOREIGN KEY (subject_id) REFERENCES contexts (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_contexts_zoo ADD CONSTRAINT FK_D1EF33FF7941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_contexts_zoo ADD CONSTRAINT FK_D1EF33FF23EDC87 FOREIGN KEY (subject_id) REFERENCES contexts (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_individuals ADD CONSTRAINT FK_D9985D027941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_individuals ADD CONSTRAINT FK_D9985D0223EDC87 FOREIGN KEY (subject_id) REFERENCES individuals (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_potteries ADD CONSTRAINT FK_631A18587941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_potteries ADD CONSTRAINT FK_631A185823EDC87 FOREIGN KEY (subject_id) REFERENCES potteries (id) ON DELETE RESTRICT NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE analysis_samples ADD CONSTRAINT FK_634331717941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_samples ADD CONSTRAINT FK_6343317123EDC87 FOREIGN KEY (subject_id) REFERENCES samples (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_samples_botany ADD CONSTRAINT FK_DAB964637941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_samples_botany ADD CONSTRAINT FK_DAB9646323EDC87 FOREIGN KEY (subject_id) REFERENCES samples (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_samples_microstratigraphy ADD CONSTRAINT FK_6ABB30D97941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_samples_microstratigraphy ADD CONSTRAINT FK_6ABB30D923EDC87 FOREIGN KEY (subject_id) REFERENCES samples (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_sediment_core_depth_botany_taxonomies ADD CONSTRAINT FK_C9C460717941003F FOREIGN KEY (analysis_id) REFERENCES analysis_sediment_core_depths_botany (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_sediment_core_depth_botany_taxonomies ADD CONSTRAINT FK_C9C460719557E6F6 FOREIGN KEY (taxonomy_id) REFERENCES vocabulary.botany_taxonomy (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_sediment_core_depths ADD CONSTRAINT FK_5AAF384D7941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_sediment_core_depths ADD CONSTRAINT FK_5AAF384D23EDC87 FOREIGN KEY (subject_id) REFERENCES sediment_core_depths (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_sediment_core_depths_botany ADD CONSTRAINT FK_F27267787941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_sediment_core_depths_botany ADD CONSTRAINT FK_F272677823EDC87 FOREIGN KEY (subject_id) REFERENCES sediment_core_depths (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_sites_anthropology ADD CONSTRAINT FK_85856F2B7941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_sites_anthropology ADD CONSTRAINT FK_85856F2B23EDC87 FOREIGN KEY (subject_id) REFERENCES archaeological_sites (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_zoo_bones ADD CONSTRAINT FK_EB9AEAD07941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_zoo_bones ADD CONSTRAINT FK_EB9AEAD023EDC87 FOREIGN KEY (subject_id) REFERENCES zoo_bones (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_zoo_teeth ADD CONSTRAINT FK_BE6E6D8B7941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_zoo_teeth ADD CONSTRAINT FK_BE6E6D8B23EDC87 FOREIGN KEY (subject_id) REFERENCES zoo_teeth (id) ON DELETE RESTRICT NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE vocabulary.pottery_functional_forms ADD CONSTRAINT FK_703164D29D56156 FOREIGN KEY (functional_group_id) REFERENCES vocabulary.pottery_functional_groups (id) NOT DEFERRABLE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE analysis_sediment_core_depth_botany_taxonomies_id_seq CASCADE');
        ...
        $this->addSql('DROP SEQUENCE vocabulary.zoo_bone_end_preserved_id_seq CASCADE');
        ...
        $this->addSql('ALTER TABLE abs_dating_analysis_samples DROP CONSTRAINT FK_ADDD1B67BF396750');
        $this->addSql('ALTER TABLE abs_dating_analysis_sediment_core_depths DROP CONSTRAINT FK_515C9693BF396750');
        ...
        $this->addSql('ALTER TABLE analysis_sediment_core_depth_botany_taxonomies DROP CONSTRAINT FK_C9C460717941003F');
        $this->addSql('ALTER TABLE analysis_sediment_core_depth_botany_taxonomies DROP CONSTRAINT FK_C9C460719557E6F6');
        $this->addSql('ALTER TABLE analysis_sediment_core_depths DROP CONSTRAINT FK_5AAF384D7941003F');
        $this->addSql('ALTER TABLE analysis_sediment_core_depths DROP CONSTRAINT FK_5AAF384D23EDC87');
        $this->addSql('ALTER TABLE analysis_sediment_core_depths_botany DROP CONSTRAINT FK_F27267787941003F');
        $this->addSql('ALTER TABLE analysis_sediment_core_depths_botany DROP CONSTRAINT FK_F272677823EDC87');
        ...
        $this->addSql('ALTER TABLE vocabulary.pottery_functional_forms DROP CONSTRAINT FK_703164D29D56156');
        ...
        $this->addSql('DROP TABLE abs_dating_analysis_samples');
        $this->addSql('DROP TABLE abs_dating_analysis_sediment_core_depths');
        ...
        $this->addSql('DROP TABLE analysis_sediment_core_depth_botany_taxonomies');
        $this->addSql('DROP TABLE analysis_sediment_core_depths');
        $this->addSql('DROP TABLE analysis_sediment_core_depths_botany');
