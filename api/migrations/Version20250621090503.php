...
final class Version20250621090503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE abs_dating_analysis_samples (dating_lower SMALLINT NOT NULL, dating_upper SMALLINT NOT NULL, uncalibrated_dating SMALLINT NOT NULL, error SMALLINT NOT NULL, calibration_curve VARCHAR(255) NOT NULL, notes TEXT DEFAULT NULL, id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE TABLE abs_dating_analysis_sediment_cores (dating_lower SMALLINT NOT NULL, dating_upper SMALLINT NOT NULL, uncalibrated_dating SMALLINT NOT NULL, error SMALLINT NOT NULL, calibration_curve VARCHAR(255) NOT NULL, notes TEXT DEFAULT NULL, id BIGINT NOT NULL, PRIMARY KEY (id))');
