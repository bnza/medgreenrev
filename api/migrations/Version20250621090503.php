...
final class Version20250621090503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE analysis_sediment_core_depths ADD CONSTRAINT FK_5AAF384D23EDC87 FOREIGN KEY (subject_id) REFERENCES sediment_core_depths (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_sediment_core_depths_botany ADD CONSTRAINT FK_F27267787941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_sediment_core_depths_botany ADD CONSTRAINT FK_F272677823EDC87 FOREIGN KEY (subject_id) REFERENCES sediment_core_depths (id) ON DELETE CASCADE NOT DEFERRABLE');
