...
class ApiResourceAnalysisZooToothMaterialAnalystTest extends ApiTestCase
{
    ...
    public function testPostGetCollectionParentSubjectAclReturnsTrueForMaterialAnalystUser(): void
    {
        ...
        $subjectResponse = $this->apiRequest($client, 'GET', '/api/data/zoo/teeth?itemsPerPage=1', ['token' => $adminToken]);
        ...
        $email = 'mat_analyst_zoo_tooth_test@example.com';
        ...
        $collectionResponse = $this->apiRequest($client, 'GET', "/api/data/zoo/teeth/$subjectId/analyses", ['token' => $matToken]);
