...
class ApiResourceStratigraphicUnitGeoserverTest extends ApiTestCase
{
    ...
    public function testGetCollectionJsonUnfiltered(): void
    {
        ...
        $collectionResponse = $this->apiRequest($client, 'GET', '/api/features/stratigraphic_units', [
            'token' => $token,
            'headers' => [
    ...
    public function testGetCollectionJsonFiltered(): void
    {
        ...
        $unfilteredResponse = $this->apiRequest($client, 'GET', '/api/features/stratigraphic_units', [
            'token' => $token,
            'headers' => [
                'Accept' => 'application/json',
            ],
        ...
        // Get filtered counts
        $collectionResponse = $this->apiRequest($client, 'GET', '/api/features/stratigraphic_units?number=1', [
            'token' => $token,
            'headers' => [
                'Accept' => 'application/json',
            ],
    ...
    public function testGetCollectionGeoJson(): void
    {
        ...
        $this->assertStringStartsWith('stratigraphic_units:', $firstFeature['id']);
    }
    ...
    public function testGetNumberMatched(): void
    {
        ...
        $collectionResponse = $this->apiRequest($client, 'GET', '/api/features/number_matched/stratigraphic_units', [
            'token' => $token,
        ]);
        $this->assertResponseStatusCodeSame(200);
    ...
    public function testGetExtentMatched(): void
    {
        ...
        $collectionResponse = $this->apiRequest($client, 'GET', '/api/features/extent_matched/stratigraphic_units', [
            'token' => $token,
        ]);
        $this->assertResponseStatusCodeSame(200);
        $responseArray = $collectionResponse->toArray();
    ...
    public function testAggregatedFeatureCollectionFilterConsistency(): void
    {
        ...
        $filterParam = 'year=2024';

        // Step 1: Fetch all stratigraphic units filtered by year
        $filteredResponse = $this->apiRequest($client, 'GET', '/api/data/stratigraphic_units?page=1&itemsPerPage=500&'.$filterParam);
        $this->assertResponseStatusCodeSame(200);
        $filteredData = json_decode($filteredResponse->getContent(), true);
        $filteredMembers = $filteredData['member'];
        $this->assertNotEmpty($filteredMembers, 'Need at least one stratigraphic unit with year 2024 in fixtures');
        ...
        $aggResponse = $this->apiRequest($client, 'GET', '/api/features/stratigraphic_units?'.$filterParam, [
            'headers' => [
                'Accept' => 'application/json',
            ],
        ]);
    ...
    public function testGetExport(): void
    {
        ...
        $collectionResponse = $this->apiRequest($client, 'GET', '/api/features/export/stratigraphic_units', [
            'token' => $token,
        ]);
        $this->assertResponseStatusCodeSame(200);
    }
