...
class ApiResourceAnalysisPotteryMaterialAnalystTest extends ApiTestCase
{
    ...
    public function testPostGetCollectionParentSubjectAclReturnsTrueForMaterialAnalystUser(): void
    {
        ...
        $subjectResponse = $this->apiRequest($client, 'GET', '/api/data/potteries?itemsPerPage=1', ['token' => $adminToken]);
        ...
        $email = 'mat_analyst_pottery_test@example.com';
        ...
        $collectionResponse = $this->apiRequest($client, 'GET', "/api/data/potteries/$subjectId/analyses", ['token' => $matToken]);
