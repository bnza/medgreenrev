...
class ApiResourceAnalysisBotanyCharcoalMaterialAnalystTest extends ApiTestCase
{
    ...
    public function testPostGetCollectionParentSubjectAclReturnsTrueForMaterialAnalystUser(): void
    {
        ...
        $subjectResponse = $this->apiRequest($client, 'GET', '/api/data/botany/charcoals?itemsPerPage=1', ['token' => $adminToken]);
        ...
        $email = 'mat_analyst_charcoal_test@example.com';
        ...
        $collectionResponse = $this->apiRequest($client, 'GET', "/api/data/botany/charcoals/$subjectId/analyses", ['token' => $matToken]);
