...
class ApiResourceAnalysisZooBoneMaterialAnalystTest extends ApiTestCase
{
    ...
    public function testPostGetCollectionParentSubjectAclReturnsTrueForMaterialAnalystUser(): void
    {
        ...
        $subjectResponse = $this->apiRequest($client, 'GET', '/api/data/zoo/bones?itemsPerPage=1', ['token' => $adminToken]);
        ...
        $email = 'mat_analyst_zoo_bone_test@example.com';
        ...
        $collectionResponse = $this->apiRequest($client, 'GET', "/api/data/zoo/bones/$subjectId/analyses", ['token' => $matToken]);
