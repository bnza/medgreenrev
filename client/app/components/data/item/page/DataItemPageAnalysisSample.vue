...
const path = '/api/data/analyses/samples/{id}' as const
...
<template>
  <data-item-page :path identifier-prop="id">
    <template #default="{ item }: { item: GetItemResponse }">
      <lazy-data-item-form-info-analysis-sample :item />
      ...
      <v-tabs-window v-model="tab">
        ...
        >
          <data-item-page-abs-dating-analysis
            resource-key="absDatingAnalysisSample"
    ...
    <template #dialogs="{ refetch }">
      <data-dialog-delete-analysis-sample
