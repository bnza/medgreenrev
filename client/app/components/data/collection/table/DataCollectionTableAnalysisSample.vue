<script
  ...
  generic="
    Path extends
      | Extract<GetCollectionPath, '/api/data/analyses/samples'>
...
const { deleteDialogState } = storeToRefs(
  useResourceDeleteDialogStore('/api/data/analyses/samples/{id}'),
)
const { updateDialogState } = storeToRefs(
  useResourceUpdateDialogStore('/api/data/analyses/samples/{id}'),
)
...
<template>
  <data-collection-table :path :parent-id @acl="acl = { ...acl, ...$event }">
    ...
    <template #dialogs="{ refetch }">
      ...
      <data-dialog-create-analysis-sample :path :parent @refresh="refetch()" />
      <data-dialog-delete-analysis-sample @refresh="refetch()" />
      <data-dialog-update-analysis-sample @refresh="refetch()" />
    </template>
