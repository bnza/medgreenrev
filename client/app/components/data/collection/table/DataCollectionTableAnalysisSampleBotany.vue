<script
  ...
  generic="
    Path extends
      | Extract<GetCollectionPath, '/api/data/analyses/samples/botany'>
...
const { deleteDialogState } = storeToRefs(
  useResourceDeleteDialogStore('/api/data/analyses/samples/botany/{id}'),
)
const { updateDialogState } = storeToRefs(
  useResourceUpdateDialogStore('/api/data/analyses/samples/botany/{id}'),
)
  ...
  <data-collection-table :path :parent-id @acl="acl = { ...acl, ...$event }">
    ...
    <template #dialogs="{ refetch }">
      ...
      <data-dialog-create-analysis-sample-botany
        ...
        @refresh="refetch()"
      />
      <data-dialog-delete-analysis-sample-botany @refresh="refetch()" />
